...
# OFB and GCM are stream compile
...
ciphertext = encrypt2(plaintext.encode(),key,AES.MODE_GCM,iv.encode())
print ("Cipher (GCM): "+binascii.hexlify(bytearray(ciphertext)).decode())

plaintext = decrypt2(ciphertext,key,AES.MODE_GCM,iv.encode())
